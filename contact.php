...
<main class="contact">
        <section class="contact__content">
            <div class="contact__content_img">
                ...
                <div class="contact__content_block">
                    <h2 class="contact__content_name"><?php echo get_theme_mod('contact__content_name'); ?></h2>
                    <p class="contact__content_text">
                        <?php echo get_theme_mod('contact__content_text'); ?>
                    </p>
                </div>
        ...
        <section class="contact__connection">
            <div class="container">
                <div class="contact__connection_holder">
                    <h2 class="contact__connection_name"><?php echo get_theme_mod('contact__connection_name'); ?></h2>
                    <div class="team__about_person">
                        ...
                        <div class="contact__connection_text_holder">
                            <p class="contact__connection_person_text contact__connection_1person_mail">E-mail: <?php echo get_theme_mod('contact__connection_1person_mail'); ?></p>
                            <p class="contact__connection_person_text contact__connection_1person_phone">Phone:<?php echo get_theme_mod('contact__connection_1person_phone'); ?></p>
                        </div>
                    </div>
                    <div class="team__about_person">                   
                        <div class="team__person_img_holder">
                        ...
                        <div class="contact__connection_text_holder">
                            <p class="contact__connection_person_text contact__connection_2person_mail">E-mail: <?php echo get_theme_mod('contact__connection_2person_mail'); ?></p>
                            <p class="contact__connection_person_text contact__connection_2person_phone">Phone: <?php echo get_theme_mod('contact__connection_2person_phone'); ?></p>
                        </div>
                    </div>
                    <div class="team__about_person">
                        <div class="team__person_img_holder">
                        ...
                        <div class="contact__connection_text_holder">
                            <p class="contact__connection_person_text contact__connection_3person_mail">E-mail: <?php echo get_theme_mod('contact__connection_3person_mail'); ?></p>
                            <p class="contact__connection_person_text contact__connection_3person_phone">Phone: <?php echo get_theme_mod('contact__connection_3person_phone'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="contact__map">
            <div class="contact__map_content">
                <h2 class="contact__map_name"><?php echo get_theme_mod('contact__map_name'); ?></h2>
                <div class="contact__map_text_holder">
                    <p class="contact__map_text contact__map_text"><?php echo get_theme_mod('contact__map_text'); ?></p>
                    <p class="contact__map_text contact__map_office"><?php echo get_theme_mod('contact__map_office'); ?></p>
                    <p class="contact__map_text contact__map_location"><?php echo get_theme_mod('contact__map_location'); ?></p>
                </div>
            </div>
